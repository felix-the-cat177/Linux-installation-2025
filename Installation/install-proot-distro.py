...
def debian_system():
  ...
  with open("Dados/user.json", "r") as user_json:
    ...
    os.system("wget https://raw.githubusercontent.com/LinuxDroidMaster/Termux-Desktops/main/scripts/proot_debian/startcinnamon_debian.sh && mv startcinnamon_debian.sh ~ && cd ~")
    os.system("chmod +x startcinnamon_debian.sh")
    os.system(clear)
    ...
    print(f'[✓] meu canal: https://youtube.com/@dxynamoyt?si=L4dDRu7bQyNuh3H6{Fore.RESET}')
